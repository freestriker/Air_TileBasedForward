		...
		namespace Graphic
		{
			...
			namespace RenderPass
			{
				...
				private:
					...
					void OnPopulateCommandBuffer(Command::CommandPool* commandPool, std::multimap<float, Renderer::Renderer*>& renderDistanceTable, Manager::RenderPassObject* renderPassObject)override;
