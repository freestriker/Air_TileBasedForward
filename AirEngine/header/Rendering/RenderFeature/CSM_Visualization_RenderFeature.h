...
namespace AirEngine
{
	...
	namespace Rendering
	{
		...
		{
			class CSM_Visualization_RenderFeature final : public Core::Graphic::Rendering::RenderFeatureBase
			{
			public:
				class CSM_Visualization_RenderPass final : public Core::Graphic::Rendering::RenderPassBase
				{
				private:
					void OnPopulateRenderPassSettings(RenderPassSettings& settings)override;
				public:
					CONSTRUCTOR(CSM_Visualization_RenderPass)
					RTTR_ENABLE(Core::Graphic::Rendering::RenderPassBase)
				};

				class CSM_Visualization_RenderFeatureData final : public Core::Graphic::Rendering::RenderFeatureDataBase
				{
					friend class CSM_Visualization_RenderFeature;
				private:
				...
				public:
					Core::Graphic::Rendering::RenderFeatureDataBase* csmRenderFeatureData;
					Core::Graphic::Rendering::RenderFeatureDataBase* geometryRenderFeatureData;

					CONSTRUCTOR(CSM_Visualization_RenderFeatureData)
					RTTR_ENABLE(Core::Graphic::Rendering::RenderFeatureDataBase)
				};

				CONSTRUCTOR(CSM_Visualization_RenderFeature)
