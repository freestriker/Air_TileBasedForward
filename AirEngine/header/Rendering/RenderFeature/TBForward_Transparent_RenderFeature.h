...
namespace AirEngine
{
	namespace Rendering
	{
		...
		{
			class TBForward_Transparent_RenderFeature final : public Core::Graphic::Rendering::RenderFeatureBase
			{
			public:
				class TBForward_Transparent_RenderPass final : public Core::Graphic::Rendering::RenderPassBase
				{
				private:
					void OnPopulateRenderPassSettings(RenderPassSettings& settings)override;
				public:
					CONSTRUCTOR(TBForward_Transparent_RenderPass)
					RTTR_ENABLE(Core::Graphic::Rendering::RenderPassBase)
				};

				class TBForward_Transparent_RenderFeatureData final : public Core::Graphic::Rendering::RenderFeatureDataBase
				{
					friend class TBForward_Transparent_RenderFeature;
				private:
					Core::Graphic::Rendering::FrameBuffer* frameBuffer;
				public:
					Core::Graphic::Instance::Buffer* transparentLightIndexListsBuffer;

					CONSTRUCTOR(TBForward_Transparent_RenderFeatureData)
					RTTR_ENABLE(Core::Graphic::Rendering::RenderFeatureDataBase)
				};

				CONSTRUCTOR(TBForward_Transparent_RenderFeature)
