...
namespace AirEngine
{
	...
	namespace Rendering
	{
		namespace Renderer
		{
			class AmbientOcclusionRenderer final : public Core::Graphic::Rendering::RendererBase
			{
			public:
				enum class AoType
				{
			...
			public:
				class AmbientOcclusionRendererData final : public Core::Graphic::Rendering::RendererDataBase
				{
				public:
					AoType aoType = AoType::SSAO;
				public:
					CONSTRUCTOR(AmbientOcclusionRendererData)

						RTTR_ENABLE(Core::Graphic::Rendering::RendererDataBase)
				};

				CONSTRUCTOR(AmbientOcclusionRenderer)
