    ...
    , _queueName(queueName)
{
    ...
    poolInfo.flags = flag;
    poolInfo.queueFamilyIndex = Graphic::CoreObject::VulkanInstance::Queue_(std::string(queueName))->queueFamilyIndex;

    Utils::Log::Exception("Failed to create command pool.", vkCreateCommandPool(Graphic::CoreObject::VulkanInstance::VulkanDevice_(), &poolInfo, nullptr, &_vkCommandPool));
}
...
AirEngine::Core::Graphic::Command::CommandPool::~CommandPool()
{
    ...
    vkDestroyCommandPool(Graphic::CoreObject::VulkanInstance::VulkanDevice_(), _vkCommandPool, nullptr);
}
...
void AirEngine::Core::Graphic::Command::CommandPool::Reset()
{
    ...
    vkResetCommandPool(Graphic::CoreObject::VulkanInstance::VulkanDevice_(), _vkCommandPool, VkCommandPoolResetFlagBits::VK_COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT);
}
