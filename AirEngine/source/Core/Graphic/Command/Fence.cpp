	...
	: _vkFence(VK_NULL_HANDLE)
{
    ...
    Utils::Log::Exception("Failed to create synchronization objects for a frame.", vkCreateFence(Graphic::CoreObject::Instance::VkDevice_(), &fenceInfo, nullptr, &_vkFence));
}
