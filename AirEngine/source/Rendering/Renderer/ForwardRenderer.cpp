...
void AirEngine::Rendering::Renderer::ForwardRenderer::OnResolveRendererData(Core::Graphic::Rendering::RendererDataBase* rendererData, Camera::CameraBase* camera)
{
	...
	auto geometryFeatureData = static_cast<RenderFeature::Geometry_RenderFeature::Geometry_RenderFeatureData*>(rendererData->RenderFeatureData("Geometry_RenderFeature"));
