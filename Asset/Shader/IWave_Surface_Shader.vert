...
void main() 
{
    vec2 aPosition = (vertexPosition.xz - vec2(iWaveSurfaceConstantInfo.minVertexPosition)) / vec2(iWaveSurfaceConstantInfo.maxVertexPosition - iWaveSurfaceConstantInfo.minVertexPosition);
